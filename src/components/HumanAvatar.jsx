...
export function HumanAvatar({ isSpeaking, personality = "aggressive", confidence = 70 }) {
  const pal = PALETTES[personality] || PALETTES.aggressive;
  return (
    <div className={`avatar-wrap ${isSpeaking ? "avatar-speaking" : ""}`}>
      ...
      <svg viewBox="0 0 240 300" xmlns="http://www.w3.org/2000/svg" className="avatar-svg">
        <defs>
          ...
          <radialGradient id="ew" cx="38%" cy="32%" r="68%">
        ...
        {/* Eyes */}
        <ellipse cx="92" cy="110" rx="16" ry="12" fill="url(#ew)"/>
        <ellipse cx="148" cy="110" rx="16" ry="12" fill="url(#ew)"/>
